...
Kaiseki.prototype = {
  ...
  loginFacebookUser: function(facebookAuthData, signupSource, callback) {
    if (_.isFunction(signupSource)) {
      callback = signupSource;
      signupSource = undefined;
    }
    this._socialLogin({facebook: facebookAuthData}, signupSource, callback);
  },

  loginTwitterUser: function(twitterAuthData, signupSource, callback) {
    if (_.isFunction(signupSource)) {
      callback = signupSource;
      signupSource = undefined;
    }
    this._socialLogin({twitter: twitterAuthData}, signupSource, callback);
  },
