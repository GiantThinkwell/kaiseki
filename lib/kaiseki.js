...
Kaiseki.prototype = {
  ...
  loginFacebookUser: function(facebookAuthData, userDefaults, callback) {
    if (_.isFunction(userDefaults)) {
      callback = userDefaults;
      userDefaults = undefined;
    }
    this._socialLogin({facebook: facebookAuthData}, userDefaults, callback);
  },

  loginTwitterUser: function(twitterAuthData, userDefaults, callback) {
    if (_.isFunction(userDefaults)) {
      callback = userDefaults;
      userDefaults = undefined;
    }
    this._socialLogin({twitter: twitterAuthData}, userDefaults, callback);
  },
  ...
  _socialLogin: function(authData, userDefaults, callback) {
    var params = {};
    if (userDefaults && _.isObject(userDefaults)) {
      params = userDefaults;
    }
  ...
  _jsonRequest: function(opts) {
    ...
    this.request(this.API_BASE_URL + opts.url, reqOpts, function(err, res, body) {
